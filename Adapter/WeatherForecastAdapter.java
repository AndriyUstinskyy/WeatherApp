package com.example.andriy.weatherapp.Adapter;
...
import com.example.andriy.weatherapp.R;
...
public class WeatherForecastAdapter extends RecyclerView.Adapter<WeatherForecastAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_date_time.setText(new StringBuilder(Common.convetUnixToDate(weatherForecastResult.list.get(position).dt)));
